...
export default function ProfileNavigation() {
  ...
  return (
    <div className=" bg-[#85929E] rounded-lg p-3 lg:p-4 xl:p-10">
      ...
      <Link href="/pages/profile/packages">
        <div className="border-b-2 border-b-[#ffffff] pb-2 md:pb-4 mt-6 md:mt-10">
          <p className={`${pathname == '/pages/profile/packages' ? 'text-[#05FB1E]':'text-[#ffffff]'} text-[14px] lg:text-[16px] xl:text-[20px] font-medium`}>
            3 Package Purchased
          </p>
        </div>
      </Link>
      <Link href="/pages/profile/wallets">
        <div className="border-b-2 border-b-[#ffffff] pb-2 md:pb-4 mt-6">
          <p className={`${pathname == '/pages/profile/wallets' ? 'text-[#05FB1E]':'text-[#ffffff]'} text-[14px] lg:text-[16px] xl:text-[20px] font-medium`}>
            3 Wallets Added
          </p>
        </div>
      </Link>
      <Link href="/pages/profile/withdraw">
        <div className="border-b-2 border-b-[#ffffff] pb-2 md:pb-4 mt-6">
          <p className={`${pathname == '/pages/profile/withdraw' ? 'text-[#05FB1E]':'text-[#ffffff]'} text-[14px] lg:text-[16px] xl:text-[20px] font-medium`}>
            3 Withdraw Request
          </p>
        </div>
      </Link>
      <Link href="/pages/profile">
        <div className="border-b-2 border-b-[#ffffff] pb-2 md:pb-4 mt-6">
          <p className={` ${pathname == '/pages/profile' ? 'text-[#05FB1E]':'text-[#ffffff]'} text-[14px] lg:text-[16px] xl:text-[20px] font-medium`}>
            10 Content Views
          </p>
        </div>
      </Link>
