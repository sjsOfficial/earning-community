          ...
          <div className="flex flex-col mt-4 space-y-4">
            <div className="flex gap-2 justify-between items-center flex-wrap">
              <TextField
                ...
                variant="standard"
              />
              <div className="flex gap-2 items-center border p-1 rounded cursor-pointer hover:scale-105 duration-300">
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 14 14"
                ...
                <p className="text-[#61FF00] font-medium text-[14px] ">
                  Verify phone
                </p>
              </div>
            </div>
